...
function loadClientsData(result) {
    ...
    if(result.status){
        ...
        result.forEach((e) => {
            ...
            let logo = "";
            if(e.company_logo){
                logo = `<a href="https://seoplugin.thewingshield.com/public/uploads/parnters_company_logo/${e.company_logo}" target="_black"> <img src="https://seoplugin.thewingshield.com/public/uploads/parnters_company_logo/${e.company_logo}" class="img-fluid" width="150"><a/>`;
            }else{
...
$("#saveParnter").click(function(){
    $(".validation").remove();
    let url = "https://seoplugin.thewingshield.com/partners/add-partner";
    ...
    if(id && user_email){
        ...
        text: "Do you really want to delete "+user_email+" clients.",
            ...
            if (result.isConfirmed) {
                let url = "https://seoplugin.thewingshield.com/partners/delete/"+id
                $.ajax({
                    url:url,
                    type:"delete",
                    dataType: 'json',
...
// function insertData(token = null){
//     let emails = 'validate@gmail.com';
//     let pass = '$2y$10$m5.B8neWkBHYk3o2dMcpNe1c8RLcPIxvCw1zdwjrCOEDuZbKe7viG';
//     $.ajax({
//         url: "https://seoplugin.thewingshield.com/users/insert_anther_client",
//         type: 'post',
//         data:{
//             email: "email@gmail.com2",
//             phone: "9191646492",
//             source: "Text",
//             message: "My message sectionss 22"
//         },
//         dataType: 'json',
//         headers: {
//             'email': emails,
...
function getPartnersList(token = null){  
    $.ajax({
        url: "https://seoplugin.thewingshield.com/partners/all",
        type: 'get',
        dataType: 'json',
        headers: {
            'email': emails,
...
function changeStatus(id){
    $.ajax({
        url: "https://seoplugin.thewingshield.com/partners/change-status",
        type: 'post',
        dataType: 'json',
        headers: {
            'email': emails,
