/*! For license information please see chart-circle.js.LICENSE.txt */
!(function (e) {
  var t = {};
  function n(r) {
        ...
        function Ce(e, t, n, r, i, o) {
          return (
            ...
            le(function (o, a, s, u) {
              ...
              } else (m = Te(m === a ? m.splice(h, m.length) : m)), i ? i(null, a, m, u) : P.apply(a, m);
            })
          );
        }
        function Se(e) {
      ...
      C.ajaxSetup({
        ...
        C.each(["top", "left"], function (e, t) {
          C.cssHooks[t] = Ue(v.pixelPosition, function (e, n) {
            if (n)
              return (n = Ve(e, t)), Be.test(n) ? C(e).position()[t] + "px" : n;
          });
        }),
  ...
  29: function (e, t, n) {
    !(function (e) {
      ...
      o.circleProgress(
        ...
        setTimeout(function () {
          o.circleProgress("value", 0.7);
        }, 1e3),
        setTimeout(function () {
          o.circleProgress("value", 1);
        }, 1100),
        setTimeout(function () {
          o.circleProgress("value", 0.5);
        }, 2100);
    })(jQuery);
  },
  30: function (e, t, n) {
              ...
              initFill: function () {
                ...
                if (
                  ...
                  if (1 == a.length) this.arcFill = a[0];
                    ...
                    for (
                      var s = r.gradientAngle || 0,
                        u = r.gradientDirection || [
                          (o / 2) * (1 - Math.cos(s)),
                          (o / 2) * (1 + Math.sin(s)),
                          (o / 2) * (1 + Math.cos(s)),
                          (o / 2) * (1 - Math.sin(s)),
                        ],
                        l = i.createLinearGradient.apply(i, u),
                        c = 0;
                      c < a.length;
                      c++
                    ) {
                ...
                function d() {
                  ...
                  (r.width = n.size),
                    (r.height = n.size),
                    r.getContext("2d").drawImage(t, 0, 0, o, o),
                    (n.arcFill = n.ctx.createPattern(r, "no-repeat")),
                    n.drawFrame(n.lastFrameValue);
                }
                r.image &&
                  (r.image instanceof Image
                    ? (t = r.image)
                    : ((t = new Image()).src = r.image),
                  t.complete ? d() : (t.onload = d));
              },
              draw: function () {
                this.animation
              ...
              drawArc: function (e) {
                if (0 !== e) {
                  ...
                  t.save(),
                    t.beginPath(),
                    this.reverse
                      ? t.arc(n, n, n - r / 2, i - 2 * Math.PI * e, i)
                      : t.arc(n, n, n - r / 2, i, i + 2 * Math.PI * e),
                    (t.lineWidth = r),
