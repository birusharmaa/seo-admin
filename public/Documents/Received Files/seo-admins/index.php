		...
		<div class="page">
					...
					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"
								...
								><span class="sidemenu-label">Collapse Menu</span
					...
					<div class="inner-body">
						...
						<div class="row row-sm">
												...
												<div class="card-item">
													...
													<div class="card-item-title mb-2">
														...
														<span class="d-block tx-12 mb-0 text-muted"
															>Previous month vs this months</span
														>
													</div>
													<div class="card-item-body">
														<div class="card-item-stat">
															...
															<small
																><b class="text-success">55%</b> higher</small
															>
														</div>
													</div>
												</div>
											...
											<div class="card-body">
												<div class="card-item">
													...
													<div class="card-item-title mb-2">
														...
														>
														<span class="d-block tx-12 mb-0 text-muted"
															>Employees joined this month</span
														>
													</div>
													<div class="card-item-body">
														<div class="card-item-stat">
															...
															<small
																><b class="text-success">5%</b> Increased</small
															>
														</div>
													</div>
												</div>
												...
												<div class="card-item">
													...
													<div class="card-item-body">
														<div class="card-item-stat">
															...
															<small
																><b class="text-danger">12%</b> decrease</small
															>
														</div>
													</div>
												</div>
								...
								<div class="row row-sm">
										...
										<div class="card custom-card overflow-hidden">
											<div class="card-header border-bottom-0">
												<div>
													...
													>
													<span class="d-block tx-12 mb-0 text-muted"
														>The Project Budget is a tool used by project
														managers to estimate the total cost of a
														project</span
													>
												</div>
											</div>
											<div class="card-body pl-0">
												<div class>
													<div class="container">
														<canvas
															id="chartLine"
															class="chart-dropshadow2 ht-250"
														></canvas>
													</div>
												</div>
											</div>
													...
													<div class="d-flex">
														...
														<div class="ml-auto mt-3 d-flex">
															<div class="mr-3 d-flex text-muted tx-13">
																<span
																	class="legend bg-primary rounded-circle"
																></span
																>Project
															</div>
															<div class="d-flex text-muted tx-13">
																<span
																	class="legend bg-light rounded-circle"
																></span
																>Inprogress
															</div>
														</div>
											...
											<div class="card-body">
												<div class="row">
													<div class="col-sm-6 my-auto">
														...
														<div class="text-left">
															<h3
																class="font-weight-bold mr-3 mb-2 text-primary"
															>
																$5,240
															</h3>
										...
										<div class="card custom-card">
											<div class="card-header border-bottom-0 pb-0">
												<div>
													...
													<span class="d-block tx-12 mt-2 mb-0 text-muted">
														project work involves a group of students
														investigating .
													</span>
												</div>
											</div>
											<div class="card-body">
												<div class="row mt-1">
													...
													<div class="col-3">
														<div class="d-flex">
															<span class="tx-13"
																><i class="text-success fe fe-arrow-up"></i
																><b>24.75%</b></span
															>
														</div>
													</div>
												...
												<div class="row mt-4">
													...
													<div class="col-3">
														<div class="d-flex">
															<span class="tx-13"
																><i class="text-danger fe fe-arrow-down"></i
																><b>12.34%</b></span
															>
														</div>
													</div>
									...
									<div class="col-lg-12">
										<div class="card custom-card mg-b-20">
											<div class="card-body">
												<div
													class="card-header border-bottom-0 pt-0 pl-0 pr-0 d-flex"
												>
													<div>
														<label class="main-content-label mb-2">Tasks</label>
														<span class="d-block tx-12 mb-3 text-muted"
															>A task is accomplished by a set deadline, and
															must contribute toward work-related
															objectives.</span
														>
													</div>
													<div class="ml-auto">
														...
														<div class="dropdown-menu">
															...
															<a class="dropdown-item" href="#"
																><i class="fa fa-cog mr-2"></i> Settings</a
															>
														</div>
													</div>
												</div>
														...
														<tbody>
															<tr>
																<td class="font-weight-semibold d-flex">
																	...
																	><span class="mt-1"
																		>Evaluating the design</span
																	>
																</td>
																<td class="text-nowrap">
																	<div
																		class="demo-avatar-group my-auto float-right"
																	>
																...
																<td>
																	<span
																		class="badge badge-pill badge-primary-light"
																		>Completed</span
																	>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<span
																		class="badge badge-pill badge-warning-light"
																		>Pending</span
																	>
																</td>
															</tr>
															<tr>
																<td class="font-weight-semibold d-flex">
																	<label class="ckbox my-auto mr-4"
																		><input
																			type="checkbox" /><span></span></label
																	><span class="mt-1">Define the problem</span>
																</td>
																<td class="text-nowrap">
																	<div
																		class="demo-avatar-group my-auto float-right"
															...
															<tr>
																...
																<td>
																	<span
																		class="badge badge-pill badge-danger-light"
																		>Rejected</span
																	>
																</td>
															</tr>
							...
							<div class="col-sm-12 col-lg-12 col-xl-4 mt-xl-4">
												...
												<td class="text-right">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">
															$45.234<i
																class="fas fa-level-up-alt ml-2 text-success m-l-10"
															></i>
														</h6>
											...
											<tr>
												...
												<td class="text-right">
													<div class="d-inline-block">
														<h6 class="mb-2 tx-15 font-weight-semibold">
															$23.452<i
																class="fas fa-level-down-alt ml-2 text-danger m-l-10"
															></i>
														</h6>
										...
										<div class="row row-sm">
											<div class="col-6">
												<div class="card-item-title">
													<label
														class="main-content-label tx-13 font-weight-bold mb-2"
												...
												<p class="mb-0 tx-24 mt-2">
													<b class="text-primary">145 days</b>
												</p>
												<a href="#" class="text-muted">12 Monday, Oct 2020 </a>
											</div>
											<div class="col-6">
												<img
													src="assets/img/pngs/work.png"
													alt="image"
													class="best-emp"
												/>
											</div>
								...
								<div class="card custom-card">
									<div
										class="card-header border-bottom-0 pb-0 d-flex pl-3 ml-1"
									>
										<div>
											<label class="main-content-label mb-2 pt-2"
												>On goiong projects</label
											>
											<span class="d-block tx-12 mb-2 text-muted"
												>Projects where development work is on completion</span
											>
										...
										<div class="list-card">
											...
											<div class="card-item mt-4">
												...
												<div class="card-item-body">
													<div class="card-item-stat">
														<small
															class="tx-10 text-primary font-weight-semibold"
								...
								<div class="card custom-card">
									<div class="card-body">
										<div class="d-flex">
											<label class="main-content-label my-auto"
										...
										<div class="mt-2">
											<div>
												<span class="tx-15 text-muted"
													>Task completed : 7/10</span
												>
											</div>
											...
											<div class="col">
												<div class="mt-4">
													<div class="d-flex mb-2">
														<h5
															class="tx-15 my-auto text-muted font-weight-normal"
														>
															Client :
														</h5>
													...
													<div class="d-flex mb-0">
														<h5
															class="tx-13 my-auto text-muted font-weight-normal"
														>
															Deadline :
														</h5>
														<h5 class="tx-13 my-auto text-muted ml-2">
															25 Dec 2020
														</h5>
													</div>
												</div>
			...
			<div class="main-footer text-center">
				<div class="container">
					<div class="row row-sm">
						<div class="col-md-12">
							<span>Copyright © 2022 <a href="#">Sartia Global</a>.</span>
						</div>
					</div>
				</div>
			</div>
