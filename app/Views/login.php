						...
						<div class="row row-sm ">
							<div class="col-lg-6 col-xl-5 d-none  d-lg-block text-center bg-primary details">
								<div class="mt-5 pt-4 p-2 pos-absolute ">
									...
									<div class="admin-img" >
									<img
										src="<?=base_url();?>/assets/img/pngs/admin1.png"
										class="ht-100 mb-0"
										alt="user"
									/>
									</div>
										...
										<div class="card-body mt-2 mb-2">
											...
											<form id="signUp-form" action="#">
												...
												<div class="form-group text-left">
													...
													<input class="form-control text-dark" name="email" id="email" placeholder="Enter your email" type="email"/>
												</div>
												<div class="form-group text-left">
													<label style="font-weight:600">Password</label>
													<input class="form-control text-dark" name="password" id="password" placeholder="Enter your password" type="password"/>
												</div>
